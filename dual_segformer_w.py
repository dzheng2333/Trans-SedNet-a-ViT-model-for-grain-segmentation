...
try:
    ...
    from net_utils_mixkvweight_window import FeatureFusionModule as FFM
    from net_utils_mixkvweight_window import FeatureRectifyModule as FRM
except:
    from .droppath import DropPath
    from .net_utils_mixkvweight_window import FeatureFusionModule as FFM
    from .net_utils_mixkvweight_window import FeatureRectifyModule as FRM
...
class Block(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        # window_size = [6, 6]
        # print(window_size)
        x_window = window_partition(x, window_size=window_size, H=H, W=W)
...
class mit_b0(RGBXTransformer):
    def __init__(self, fuse_cfg=None, **kwargs):
        super(mit_b0, self).__init__(
            ...
            drop_rate=0.2, drop_path_rate=0.1, **kwargs)
...
if __name__ == '__main__':
    a = mit_b1(pretrained=None)

    i = torch.rand((1, 128, 128, 256))
    j = torch.rand((1, 128, 256, 256))

    # k = window_partition(i, 32)
    # k = window_reverse(k, 32, 128, 128)
    c = a(i, j)
    print(c)
    # b = torch.load(r'C:\Users\MI\Desktop\mit_b0.pth')
    # load_dualpath_model(a, r'C:\Users\MI\Desktop\mit_b0.pth')
